window.onload = function() {
    ...
    var initializeParameters = function() {
        ...
        primerPlacement = trial.placement;

        if(primerPlacement === 0) {
            $('.primer-photo').css({'right':'unset', 'left':'-45vh'});
        } else {
            $('.primer-photo').css({'left':'unset', 'right':'-45vh'});
        }
